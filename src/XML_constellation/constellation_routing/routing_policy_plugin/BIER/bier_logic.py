######################################
# a part of the BIER model implementation are from https://github.com/Sina222/SSM_Models/tree/main/Stateless_MC
#############################################
...
def process_packet(graph, curr_node, packet, print_info=False):
    ...
    if 'match_table' in graph.nodes[curr_node]: # If curr_node is a Ingress/Egress node
        print("'match_table' in graph.nodes --- curr node= "+str(curr_node))
