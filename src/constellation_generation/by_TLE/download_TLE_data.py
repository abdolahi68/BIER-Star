...
def download_TLE_data(constellation_name):
    ...
    try:
        ...
        if response2.status_code == 200:
            ...
            # --- Added Code ---
            # The number of items in the JSON list corresponds to the number of satellites.
            num_satellites = len(json_TLE)
            print(f"\t\t\tMostafa ---> Downloaded TLE data for {num_satellites} satellites.")
            # --- End of Added Code ---
