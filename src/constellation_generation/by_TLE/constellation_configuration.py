...
def constellation_configuration(dT , constellation_name):
    ...
    print("Mostafa Download TLE start .....")
    DOWNLOAD_TLE_DATA.download_TLE_data(constellation_name)
    print("Mostafa Download TLE End .....")
    
    print("Mostafa shells")
    ...
    print("Mostafa shells = SATELLITE_TO_SHELL_MAPPING")
    ...
    # and timeslot
        # --- Added Code ---
    # Calculate the total number of satellites by iterating through each shell
    # in the constellation and summing the number of satellites in it.
    total_satellites = sum(len(shell.satellites) for shell in constellation.shells)
    print(f"\nMostafa Constellation Configuration Total number of satellites in the {constellation.constellation_name} constellation: {total_satellites}\n")
    # --- End of Added Code ---
