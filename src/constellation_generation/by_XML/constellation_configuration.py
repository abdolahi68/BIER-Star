...
def constellation_configuration(dT , constellation_name):
    ...
    # print("Mostafa  --> constellation_configuration_information")
    # print(constellation_configuration_information)
    # convert string to int type
    number_of_shells = int(constellation_configuration_information['constellation']['number_of_shells'])
    
    # print("Mostafa  --> number_of_shells")
    ...
    for count in range(1 , number_of_shells+1 , 1):
        ...
        # Mostafa --> in orbit_configuration(sh, dT) function, it determine the location of each satellite in each shell and orbit
        ...
        # print("Mostafa sh.orbit_cycle + dT")
        # print(sh.orbit_cycle)
        # print(dT)
