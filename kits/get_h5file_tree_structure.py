...
if __name__ == '__main__':
    ...
    with h5py.File('C:/Users/Kmale/Dropbox/BIER-star/StarPerf_Simulator-release-v2.0/StarPerf_Simulator-release-v2.0/data/XML_constellation/Starlink.h5', 'r') as file:
